...
class Kiwoom(QAxWidget):
    ...
    def receiveMsg(self, screenNo, requestName, trCode, msg):
        ...
        try:
            self.msg = self.msg.encode('ISO8859-1').decode('euc-kr')    # James
        except:
            print("receiveMsg: Error Happen") # James
            self.msg += requestName + ": " + msg + "\r\n\r\n"
        print("receiveMsg: self.msg = {}".format(self.msg)) # James
    ...
    def getChejanData(self, fid):
        ...
        data = data.encode('ISO8859-1').decode('euc-kr')    # James
        # print("getChejanData: cmd={}, data={}".format(cmd, data))
        return data
