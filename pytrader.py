...
class MyWindow(QMainWindow, ui):
    ...
    def __init__(self):
        ...
        print("self.server = [{0}]".format(self.server))
    ...
    def timeout(self):
        ...
        if id(sender) == id(self.timer):
            ...
            if self.kiwoom.msg:
                ...
                print("---> self.kiwoom.msg={}".format(self.kiwoom.msg))
                # self.logTextEdit.append(self.kiwoom.msg.encode('ISO8859-1').decode('euc-kr'))   # James
    ...
    def setCodeName(self):
        ...
        if code in self.codeList:
            ...
            self.codeNameLineEdit.setText(codeName.encode('ISO8859-1').decode('euc-kr'))    # James
    ...
    def inquiryBalance(self):
        ...
        print("---> self.kiwoom.opw00018Data=", self.kiwoom.opw00018Data)

        for i in range(1, 6):
            print("{}: len={}".format(i, len(self.kiwoom.opw00018Data['accountEvaluation'])))
            if (len(self.kiwoom.opw00018Data['accountEvaluation']) >= i):
        ...
        for i in range(cnt):
            ...
            for j in range(len(stocks)):
                if j == 1:
                    ...
                    name = name.encode('ISO8859-1').decode('euc-kr')    # James
